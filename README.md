...
<div align="center" id="ISTclock"></div>
...
<p><img align="center" src="https://github-readme-streak-stats.herokuapp.com/?user=saiaryan1784&" alt="saiaryan1784" /></p>
 <script>
    // Function to display current time in IST
    function displayISTClock() {
      var options = { timeZone: 'Asia/Kolkata', timeStyle: 'medium', hour12: false };
      var ISTtime = new Date().toLocaleString('en-US', options);
      document.getElementById('ISTclock').textContent = 'Current IST Time: ' + ISTtime;
    }

    // Update clock every second
    setInterval(displayISTClock, 1000);
